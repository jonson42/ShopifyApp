...
var toc = (function () {
  ...
  var $_29yowbsbjkc9bjs9 = { create: create };

  var tocId = $_29yowbsbjkc9bjs9.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_b3yl20sajkc9bjs7.getTocClass(editor);
    var headerTag = $_b3yl20sajkc9bjs7.getTocHeader(editor);
    var selector = generateSelector($_b3yl20sajkc9bjs7.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_b3yl20sajkc9bjs7.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_b3yl20sajkc9bjs7.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_8glel6s6jkc9bjrx.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_8glel6s6jkc9bjrx.updateToc(editor);
    });
  };
  var $_73r0frs5jkc9bjru = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_b3yl20sajkc9bjs7.getTocClass(editor);
  ...
  var $_9oznjxscjkc9bjsb = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_8glel6s6jkc9bjrx.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_b3yl20sajkc9bjs7.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_52p7q2sdjkc9bjsd = { register: register$1 };

  global.add('toc', function (editor) {
    $_73r0frs5jkc9bjru.register(editor);
    $_52p7q2sdjkc9bjsd.register(editor);
    $_9oznjxscjkc9bjsb.setup(editor);
  });
  function Plugin () {
  }
