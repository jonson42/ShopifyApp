...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_7uutik93jkc9bcbm.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_7uutik93jkc9bcbm.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_7uutik93jkc9bcbm.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_7uutik93jkc9bcbm.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_7uutik93jkc9bcbm.getAutoResizeBottomMargin(editor);
    ...
    if ($_7uutik93jkc9bcbm.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_9y6int90jkc9bcbc.resize(editor, oldSize);
    });
  };
  var $_e5sstk8zjkc9bcb7 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_e5sstk8zjkc9bcb7.register(editor, oldSize);
      $_9y6int90jkc9bcbc.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
