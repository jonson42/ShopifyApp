...
var emoticons = (function () {
  ...
  var $_9fj767bajkc9bcpx = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_9fj767bajkc9bcpx.getHtml(pluginUrl);
  ...
  var $_d33s2cb9jkc9bcpv = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_d33s2cb9jkc9bcpv.register(editor, pluginUrl);
  });
  function Plugin () {
  }
