...
var help = (function () {
  ...
  var $_vy10mbmjkc9bcs5 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_vy10mbmjkc9bcs5.shortcuts, function (shortcut) {
  ...
  var $_g2ge9xbgjkc9bcqn = { makeTab: makeTab };
  ...
  var $_bq63qybojkc9bcsc = { makeTab: makeTab$1 };
  ...
  var $_ehf31bbujkc9bcuw = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_g2ge9xbgjkc9bcqn.makeTab(),
          $_bq63qybojkc9bcsc.makeTab(editor)
        ],
        buttons: $_ehf31bbujkc9bcuw.makeRow(),
  ...
  var $_flrb8fbfjkc9bcqk = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_flrb8fbfjkc9bcqk.open(editor, pluginUrl));
  };
  var $_8w1pycbejkc9bcqh = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_flrb8fbfjkc9bcqk.open(editor, pluginUrl)
    });
  ...
  var $_3ohn4cbwjkc9bcuz = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_3ohn4cbwjkc9bcuz.register(editor, pluginUrl);
    $_8w1pycbejkc9bcqh.register(editor, pluginUrl);
