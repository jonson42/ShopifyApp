...
var contextmenu = (function () {
  ...
  var $_al3defavjkc9bcoc = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_dqbz72aujkc9bcoa.getContextMenu(editor);
  ...
  var $_d60a9jayjkc9bcom = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_dqbz72aujkc9bcoa.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_d60a9jayjkc9bcom.show(editor, $_al3defavjkc9bcoc.getPos(editor, e), visibleState, menu);
    });
  };
  var $_6zwdp4atjkc9bco6 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_6zwdp4atjkc9bco6.setup(editor, visibleState, menu);
    return $_6g9tcoasjkc9bco1.get(visibleState);
  });
  function Plugin () {
  }
