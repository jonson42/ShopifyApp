...
var inlite = (function () {
  ...
  var $_37mw9d17xjkc9buvb = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_2xn8ux181jkc9buvv.fromClientRect(clientRect)) : null;
  };
  var $_45e2nd180jkc9buvp = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_5llxt217zjkc9buvm.result(predicateIds[i].id, $_45e2nd180jkc9buvp.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_5llxt217zjkc9buvm.result(predicateIds[x].id, $_45e2nd180jkc9buvp.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_5llxt217zjkc9buvm.result(id, $_45e2nd180jkc9buvp.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_5llxt217zjkc9buvm.result(id, $_45e2nd180jkc9buvp.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_4ss8bc18ajkc9bux2.isArray(value)) {
      return value;
    } else if ($_4ss8bc18ajkc9bux2.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_4ss8bc18ajkc9bux2.isBoolean(value)) {
  ...
  var $_cd0fmk189jkc9buwu = {
    getStringOr: getByTypeOr($_4ss8bc18ajkc9bux2.isString),
    getBoolOr: getByTypeOr($_4ss8bc18ajkc9bux2.isBoolean),
    getNumberOr: getByTypeOr($_4ss8bc18ajkc9bux2.isNumber),
    getHandlerOr: getByTypeOr($_4ss8bc18ajkc9bux2.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_4ss8bc18ajkc9bux2.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_2xn8ux181jkc9buvv.toClientRect(targetRect),
        contentAreaRect: $_2xn8ux181jkc9buvv.toClientRect(contentAreaRect),
        panelRect: $_2xn8ux181jkc9buvv.toClientRect(panelRect)
      });
      return $_2xn8ux181jkc9buvv.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_cd0fmk189jkc9buwu.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_cd0fmk189jkc9buwu.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_cd0fmk189jkc9buwu.getHandlerOr(editor, 'inline_toolbar_position_handler', $_dpnmfj18bjkc9bux9.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_4qfza1186jkc9buwh.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_d2egi4187jkc9buwl.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_d2egi4187jkc9buwl.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_adyv9m185jkc9buwd = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_37mw9d17xjkc9buvb.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_3z6ywn182jkc9buw0.fromContextToolbars(toolbars);
    result = $_5llxt217zjkc9buvm.match(editor, [
      $_9qkqmt17yjkc9buvg.element(elements[0], contextToolbarsPredicateIds),
      $_4ftzxq184jkc9buw6.textSelection('text'),
      $_4ftzxq184jkc9buw6.emptyTextBlock(elements, 'insert'),
      $_9qkqmt17yjkc9buvg.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_5llxt217zjkc9buvm.match(editor, [$_4ftzxq184jkc9buw6.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_adyv9m185jkc9buwd.load(editor, function () {
  ...
  var $_dufptg17tjkc9buuy = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_2nbo2r18pjkc9bv1i.parseBox(settings.border);
      self$$1.paddingBox = $_2nbo2r18pjkc9bv1i.parseBox(settings.padding);
      self$$1.marginBox = $_2nbo2r18pjkc9bv1i.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_57cr2p18xjkc9bv2u.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_2nbo2r18pjkc9bv1i.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_2nbo2r18pjkc9bv1i.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_2nbo2r18pjkc9bv1i.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_4e5ibc18wjkc9bv2s.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_57cr2p18xjkc9bv2u.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_57cr2p18xjkc9bv2u.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_7djcxm18yjkc9bv31 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_57cr2p18xjkc9bv2u.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_57cr2p18xjkc9bv2u.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_2nbo2r18pjkc9bv1i.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_2nbo2r18pjkc9bv1i.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_dufptg17tjkc9buuy.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_80z8li17sjkc9buus = { get: get };
  ...
  var $_b7cbeh19gjkc9bv61 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_b7cbeh19gjkc9bv61.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_e7orw619ejkc9bv5l = { blobToBase64: blobToBase64 };
  ...
  var $_53h39019kjkc9bv6f = { pickFile: pickFile };
  ...
  var $_elj3po19mjkc9bv6o = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_6d974e19ojkc9bv6s.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_6d974e19ojkc9bv6s.resolve(dom, bookmark));
  };
  ...
  var $_do47is19njkc9bv6q = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_elj3po19mjkc9bv6o.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_do47is19njkc9bv6q.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_d1j1ph19ljkc9bv6j.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_53h39019kjkc9bv6f.pickFile().then(function (files) {
          var blob = files[0];
          $_e7orw619ejkc9bv5l.blobToBase64(blob).then(function (base64) {
            $_d1j1ph19ljkc9bv6j.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_d1j1ph19ljkc9bv6j.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_6v6syt19djkc9bv5i = { addToEditor: addToEditor };
  ...
  var $_4e0w0819sjkc9bv75 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_bsni7a19ujkc9bv7g.isAbsolute(href) && $_bsni7a19ujkc9bv7g.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_d1j1ph19ljkc9bv6j.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_d1j1ph19ljkc9bv6j.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_et3gk19tjkc9bv7d = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_4ss8bc18ajkc9bux2.isArray(items)) {
      return items;
    } else if ($_4ss8bc18ajkc9bux2.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_4ss8bc18ajkc9bux2.isFunction(button)) {
            button = button();
          }
  ...
  var $_1jsca419vjkc9bv7i = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_1jsca419vjkc9bv7i.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_1jsca419vjkc9bv7i.create(editor, 'text', $_d2egi4187jkc9buwl.getTextSelectionToolbarItems(editor)),
        $_1jsca419vjkc9bv7i.create(editor, 'insert', $_d2egi4187jkc9buwl.getInsertToolbarItems(editor)),
        $_et3gk19tjkc9bv7d.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_d2egi4187jkc9buwl.getPositionHandler(editor);
      contentAreaRect = $_45e2nd180jkc9buvp.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_dpnmfj18bjkc9bux9.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_dpnmfj18bjkc9bux9.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_4e0w0819sjkc9bv75.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_dpnmfj18bjkc9bux9.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_45e2nd180jkc9buvp.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_dpnmfj18bjkc9bux9.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_dpnmfj18bjkc9bux9.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_4qfza1186jkc9buwh.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_5uyid1apjkc9bvcf.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_5uyid1apjkc9bvcf.ELEMENT);
  var isText = isType$2($_5uyid1apjkc9bvcf.TEXT);
  var isDocument = isType$2($_5uyid1apjkc9bvcf.DOCUMENT);
  var $_6df1hr1aojkc9bvce = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_6df1hr1aojkc9bvce.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_4ex3ki1awjkc9bveb = { toArray: toArray };

  var node = function () {
    var f = $_b7cbeh19gjkc9bv61.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_akhm761b2jkc9bvg5.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_akhm761b2jkc9bvg5.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_akhm761b2jkc9bvg5.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_4iup8b1b6jkc9bvh6 = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_4iup8b1b6jkc9bvh6.browsers();
    var oses = $_4iup8b1b6jkc9bvh6.oses();
    var browser = $_95tjvs1b5jkc9bvgv.detectBrowser(browsers, userAgent).fold($_1bqzst1b1jkc9bvfu.unknown, $_1bqzst1b1jkc9bvfu.nu);
    var os = $_95tjvs1b5jkc9bvgv.detectOs(oses, userAgent).fold($_cau2y81b3jkc9bvg7.unknown, $_cau2y81b3jkc9bvg7.nu);
  ...
  var $_6bez5i1b0jkc9bvfs = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_6bez5i1b0jkc9bvfs.detect(userAgent);
  });
  var $_f69ab51azjkc9bvff = { detect: detect$3 };

  var ELEMENT = $_5uyid1apjkc9bvcf.ELEMENT;
  var DOCUMENT = $_5uyid1apjkc9bvcf.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_793dmu1ayjkc9bvfe.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_f69ab51azjkc9bvff.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_28yrhp1axjkc9bved = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_21jcyt1bajkc9bvi0.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_28yrhp1axjkc9bved.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_28yrhp1axjkc9bved.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_4ex3ki1awjkc9bveb.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_4ex3ki1awjkc9bveb.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_ftpznu1amjkc9bvbv.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_7ajnki1aqjkc9bvck.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_7ajnki1aqjkc9bvck.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_7ajnki1aqjkc9bvck.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_7ajnki1aqjkc9bvck.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_21jcyt1bajkc9bvi0.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_18bm4n1aljkc9bvbj.ancestors(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_18bm4n1aljkc9bvbj.siblings(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_18bm4n1aljkc9bvbj.children(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_21jcyt1bajkc9bvi0.all(selector, scope);
  };
  var $_dl50681akjkc9bvbi = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_dl50681akjkc9bvbi.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_12eirl1ahjkc9bv9u = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_12eirl1ahjkc9bv9u.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_ftpznu1amjkc9bvbv.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_28yrhp1axjkc9bved.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_21jcyt1bajkc9bvi0.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_7owts51bgjkc9bvje.ancestor(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_7owts51bgjkc9bvje.sibling(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_7owts51bgjkc9bvje.child(scope, function (e) {
      return $_21jcyt1bajkc9bvi0.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_21jcyt1bajkc9bvi0.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_21jcyt1bajkc9bvi0.is, ancestor$1, scope, selector, isRoot);
  };
  var $_e2jw9c1bfjkc9bvja = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_cmx5hb1bijkc9bvl4 = { register: register };
  ...
  var $_1lhr561bkjkc9bvlc = { register: register$1 };
  ...
  var $_f0o74z1bljkc9bvli = { register: register$2 };
  ...
  var $_bvgdc01bmjkc9bvlo = { register: register$3 };
  ...
  var $_d724fd1bnjkc9bvlt = { register: register$4 };
  ...
  var $_7ci8i21bojkc9bvlx = { register: register$5 };
  ...
  var $_5cdafa1bpjkc9bvm5 = { register: register$6 };
  ...
  var $_8g5uqd1bqjkc9bvm9 = { register: register$7 };
  ...
  var $_elsbqi1brjkc9bvmb = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_e2jw9c1bfjkc9bvja.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_d724fd1bnjkc9bvlt.register(editor);
    $_cmx5hb1bijkc9bvl4.register(editor);
    $_5cdafa1bpjkc9bvm5.register(editor);
    $_8g5uqd1bqjkc9bvm9.register(editor);
    $_f0o74z1bljkc9bvli.register(editor);
    $_1lhr561bkjkc9bvlc.register(editor);
    $_bvgdc01bmjkc9bvlo.register(editor);
    $_elsbqi1brjkc9bvmb.register(editor);
    $_7ci8i21bojkc9bvlx.register(editor);
  };
  var $_ekt18w1bejkc9bvis = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_4e5ibc18wjkc9bv2s,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_ekmkxc19ajkc9bv51,
      Panel: Panel,
      Movable: $_7djcxm18yjkc9bv31,
      Resizable: $_6z9hcy19bjkc9bv57,
      ...
      FormatControls: $_ekt18w1bejkc9bvis,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_ekt18w1bejkc9bvis.setup(editor);
    $_6v6syt19djkc9bv5i.addToEditor(editor, panel);
    return $_80z8li17sjkc9buus.get(editor, panel);
  });
  function Theme () {
  }
