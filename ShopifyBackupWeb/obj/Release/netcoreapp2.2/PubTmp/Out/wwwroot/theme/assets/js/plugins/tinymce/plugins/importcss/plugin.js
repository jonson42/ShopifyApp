...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_cw8wnhfcjkc9bdpp.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_cw8wnhfcjkc9bdpp.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_cw8wnhfcjkc9bdpp.getSelectorConverter(editor)) {
      selectorConverter = $_cw8wnhfcjkc9bdpp.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_cw8wnhfcjkc9bdpp.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_cw8wnhfcjkc9bdpp.getCssGroups(editor));
      ...
      if (!$_cw8wnhfcjkc9bdpp.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_cw8wnhfcjkc9bdpp.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_e1wfp9f7jkc9bdpg.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_32y4ubf6jkc9bdpc = { get: get };

  global.add('importcss', function (editor) {
    $_e1wfp9f7jkc9bdpg.setup(editor);
    return $_32y4ubf6jkc9bdpc.get(editor);
  });
  function Plugin () {
  }
