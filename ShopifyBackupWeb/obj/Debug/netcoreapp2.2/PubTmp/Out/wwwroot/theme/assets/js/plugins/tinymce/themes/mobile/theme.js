...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_859vixy7jkc9blec.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_859vixy7jkc9blec.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_859vixy7jkc9blec.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_3texl9ycjkc9blfk = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_3texl9ycjkc9blfk.browsers();
    var oses = $_3texl9ycjkc9blfk.oses();
    var browser = $_29h267yajkc9blf0.detectBrowser(browsers, userAgent).fold($_dge9hay6jkc9ble1.unknown, $_dge9hay6jkc9ble1.nu);
    var os = $_29h267yajkc9blf0.detectOs(oses, userAgent).fold($_16bospy8jkc9blee.unknown, $_16bospy8jkc9blee.nu);
  ...
  var $_cw926vy5jkc9bldz = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_cw926vy5jkc9bldz.detect(userAgent);
  });
  var $_1m701ry3jkc9bldm = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_1m701ry3jkc9bldm.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_6eo1fgyljkc9bljz.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_6eo1fgyljkc9bljz.ELEMENT);
  var isText = isType$1($_6eo1fgyljkc9bljz.TEXT);
  var isDocument = isType$1($_6eo1fgyljkc9bljz.DOCUMENT);
  var $_4y8xd4ykjkc9bljy = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_4y8xd4ykjkc9bljy.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_a1b038ysjkc9bllz = { toArray: toArray };
  ...
  var $_1i9uocyvjkc9bln6 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_1i9uocyvjkc9bln6.getOrDie('Node');
    return f;
  };
  ...
  var $_bre0myujkc9bln5 = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_6eo1fgyljkc9bljz.ELEMENT;
  var DOCUMENT = $_6eo1fgyljkc9bljz.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_bre0myujkc9bln5.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_1m701ry3jkc9bldm.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_7fg9auytjkc9blm0 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_eeeom6yyjkc9blnm.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_7fg9auytjkc9blm0.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_7fg9auytjkc9blm0.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_a1b038ysjkc9bllz.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_a1b038ysjkc9bllz.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_1vcnl1ynjkc9blk6.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_1vcnl1ynjkc9blk6.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_1vcnl1ynjkc9blk6.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_1vcnl1ynjkc9blk6.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_cy8p4lymjkc9blk3.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_cy8p4lymjkc9blk3.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_cy8p4lymjkc9blk3.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_cy8p4lymjkc9blk3.append(parent, x);
    });
  };
  var $_5f8gkiz0jkc9blop = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_1vcnl1ynjkc9blk6.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_1vcnl1ynjkc9blk6.children(wrapper);
    if (children.length > 0)
      $_5f8gkiz0jkc9blop.before(wrapper, children);
    remove(wrapper);
  };
  var $_33qnptyzjkc9blod = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_cy8p4lymjkc9blk3.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_at2lo4yhjkc9blij.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_33qnptyzjkc9blod.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_1vcnl1ynjkc9blk6.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_33qnptyzjkc9blod.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_cy8p4lymjkc9blk3.append(element, guiSystem.element());
    var children = $_1vcnl1ynjkc9blk6.children(guiSystem.element());
  ...
  var json = function () {
    return $_1i9uocyvjkc9bln6.getOrDie('JSON');
  };
  ...
  var $_2n9fk1zhjkc9bm0u = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_2n9fk1zhjkc9bm0u.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_7fg9auytjkc9blm0.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_2n9fk1zhjkc9bm0u.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_2n9fk1zhjkc9bm0u.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_2n9fk1zhjkc9bm0u.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_4y8xd4ykjkc9bljy.isElement(source) || !$_4y8xd4ykjkc9bljy.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_anmvmyzwjkc9bmcn = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_anmvmyzwjkc9bmcn.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_anmvmyzwjkc9bmcn.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_anmvmyzwjkc9bmcn.remove(element, attr);
    return false;
  };
  var $_dfqkbezyjkc9bmdx = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_dfqkbezyjkc9bmdx.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_dfqkbezyjkc9bmdx.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_dfqkbezyjkc9bmdx.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_55ltavzxjkc9bmdm.supports(element))
      element.dom().classList.add(clazz);
    else
      $_55ltavzxjkc9bmdm.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_55ltavzxjkc9bmdm.supports(element) ? element.dom().classList : $_55ltavzxjkc9bmdm.get(element);
    if (classList.length === 0) {
      $_anmvmyzwjkc9bmcn.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_55ltavzxjkc9bmdm.supports(element)) {
      ...
      $_55ltavzxjkc9bmdm.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_55ltavzxjkc9bmdm.supports(element) ? element.dom().classList.toggle(clazz) : $_55ltavzxjkc9bmdm.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_55ltavzxjkc9bmdm.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_55ltavzxjkc9bmdm.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_1xtwqszujkc9bmcj = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_1xtwqszujkc9bmcj.remove(element, removeCls);
    $_1xtwqszujkc9bmcj.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_1xtwqszujkc9bmcj.remove(component.element(), swapConfig.alpha());
    $_1xtwqszujkc9bmcj.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_1xtwqszujkc9bmcj.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_1xtwqszujkc9bmcj.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_at2lo4yhjkc9blij.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_7fg9auytjkc9blm0.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_bqywzp103jkc9bmfd.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_bqywzp103jkc9bmfd.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_bqywzp103jkc9bmfd.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_bqywzp103jkc9bmfd.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_bqywzp103jkc9bmfd.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_bqywzp103jkc9bmfd.descendant(scope, predicate).isSome();
  };
  var $_88k87f102jkc9bmfb = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_1vcnl1ynjkc9blk6.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_1vcnl1ynjkc9blk6.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_88k87f102jkc9bmfb.closest(a, curry($_7fg9auytjkc9blm0.eq, element));
    });
  ...
  var search = function (element) {
    return active($_1vcnl1ynjkc9blk6.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_1139q4101jkc9bmep = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_ylhrr107jkc9bmh3 = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_1vcnl1ynjkc9blk6.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_1vcnl1ynjkc9blk6.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_8hy12010gjkc9bmlb.fromHtml(content, docDom);
    $_5f8gkiz0jkc9blop.append(fragment, contentElements);
    $_33qnptyzjkc9blod.empty(element);
    $_cy8p4lymjkc9blk3.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_cy8p4lymjkc9blk3.append(container, clone);
    return get$2(container);
  };
  var $_eustcq10fjkc9bml9 = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_anmvmyzwjkc9bmcn.clone(original);
    $_anmvmyzwjkc9bmcn.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_1vcnl1ynjkc9blk6.children(deep$1(original));
    $_5f8gkiz0jkc9blop.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_cy8p4lymjkc9blk3.before(original, nu);
    var children = $_1vcnl1ynjkc9blk6.children(original);
    $_5f8gkiz0jkc9blop.append(nu, children);
    $_33qnptyzjkc9blod.remove(original);
    return nu;
  };
  var $_adagbf10hjkc9bmls = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_adagbf10hjkc9bmls.shallow(element);
    return $_eustcq10fjkc9bml9.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_1xtwqszujkc9bmcj.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_1xtwqszujkc9bmcj.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_1xtwqszujkc9bmcj.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_1xtwqszujkc9bmcj.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_6ddt7d109jkc9bmhd.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_6ddt7d109jkc9bmhd.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_1m701ry3jkc9bldm.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1139q4101jkc9bmep.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1139q4101jkc9bmep.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_1139q4101jkc9bmep.hasFocus(component.element());
  };
  ...
  var $_z4wyc117jkc9bn6f = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_z4wyc117jkc9bn6f.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_at2lo4yhjkc9blij.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_z4wyc117jkc9bn6f.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_anmvmyzwjkc9bmcn.has(element, 'style') && trim($_anmvmyzwjkc9bmcn.get(element, 'style')) === '') {
      $_anmvmyzwjkc9bmcn.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_anmvmyzwjkc9bmcn.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_anmvmyzwjkc9bmcn.remove : $_anmvmyzwjkc9bmcn.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_z4wyc117jkc9bn6f.isSupported(sourceDom) && $_z4wyc117jkc9bn6f.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_8kzuni116jkc9bn4w.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_8kzuni116jkc9bn4w.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_at2lo4yhjkc9blij.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_8kzuni116jkc9bn4w.set(element, 'max-height', absMax + 'px');
  };
  var $_2feuiu115jkc9bn4u = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_at2lo4yhjkc9blij.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_1vcnl1ynjkc9blk6.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_1vcnl1ynjkc9blk6.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_1vcnl1ynjkc9blk6.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_1vcnl1ynjkc9blk6.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_eeeom6yyjkc9blnm.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_fjcq6511ajkc9bn77.ancestors(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_fjcq6511ajkc9bn77.siblings(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_fjcq6511ajkc9bn77.children(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_eeeom6yyjkc9blnm.all(selector, scope);
  };
  var $_fztxq8119jkc9bn73 = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_eeeom6yyjkc9blnm.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_bqywzp103jkc9bmfd.ancestor(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_bqywzp103jkc9bmfd.sibling(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_bqywzp103jkc9bmfd.child(scope, function (e) {
      return $_eeeom6yyjkc9blnm.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_eeeom6yyjkc9blnm.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_eeeom6yyjkc9blnm.is, ancestor$2, scope, selector, isRoot);
  };
  var $_3hoto211bjkc9bn7j = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_fztxq8119jkc9bn73.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_1xtwqszujkc9bmcj.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_1xtwqszujkc9bmcj.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_1xtwqszujkc9bmcj.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_fztxq8119jkc9bn73.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_1xtwqszujkc9bmcj.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_3hoto211bjkc9bn7j.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_3hoto211bjkc9bn7j.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_1xtwqszujkc9bmcj.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_1139q4101jkc9bmep.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_3hoto211bjkc9bn7j.closest(element, sel);
      }).getOr(element);
      return $_2feuiu115jkc9bn4u.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_fztxq8119jkc9bn73.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_3hoto211bjkc9bn7j.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_7fg9auytjkc9blm0.eq, tabstop));
  ...
  var inside = function (target) {
    return $_4y8xd4ykjkc9bljy.name(target) === 'input' && $_anmvmyzwjkc9bmcn.get(target, 'type') !== 'radio' || $_4y8xd4ykjkc9bljy.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_8kzuni116jkc9bn4w.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_cpithd11tjkc9bnk3 = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_cpithd11tjkc9bnk3.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_cpithd11tjkc9bnk3.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_8kzuni116jkc9bn4w.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_8kzuni116jkc9bn4w.set, element, property, initial);
    var on = curry($_8kzuni116jkc9bn4w.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_6gqi4c11vjkc9bnlp.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_7fg9auytjkc9blm0.eq, current);
    var candidates = $_fztxq8119jkc9bn73.descendants(container, selector);
    var visible = filter(candidates, $_6gqi4c11vjkc9bnlp.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_7fg9auytjkc9blm0.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_3hoto211bjkc9bn7j.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_3hoto211bjkc9bn7j.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_3hoto211bjkc9bn7j.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_3hoto211bjkc9bn7j.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_3hoto211bjkc9bn7j.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_1139q4101jkc9bmep.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_fztxq8119jkc9bn73.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_3hoto211bjkc9bn7j.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_fztxq8119jkc9bn73.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_fztxq8119jkc9bn73.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_3hoto211bjkc9bn7j.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_2n9fk1zhjkc9bm0u.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_2n9fk1zhjkc9bm0u.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_anmvmyzwjkc9bmcn.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_anmvmyzwjkc9bmcn.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_4y8xd4ykjkc9bljy.isElement(elem) ? $_anmvmyzwjkc9bmcn.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_1vcnl1ynjkc9blk6.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_eustcq10fjkc9bml9.get(elem) };
    return deepMerge({
      tag: $_4y8xd4ykjkc9bljy.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_14yylm10tjkc9bmwj.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_14yylm10tjkc9bmwj.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_7mimq810sjkc9bmw1.format(command, function (button, status) {
  ...
  var isTouch = $_1m701ry3jkc9bldm.detect().deviceType.isTouch();
  ...
  var platform = $_1m701ry3jkc9bldm.detect();
  ...
  var isTouch$2 = $_1m701ry3jkc9bldm.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_8kzuni116jkc9bn4w.set(element, 'max-width', absMax + 'px');
  };
  var $_47dobq130jkc9box3 = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_1m701ry3jkc9bldm.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_47dobq130jkc9box3.get(thumb.element()) / 2;
      $_8kzuni116jkc9bn4w.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_8kzuni116jkc9bn4w.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_5wxb4r10ujkc9bmwt.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_8kzuni116jkc9bn4w.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_14yylm10tjkc9bmwj.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_7mimq810sjkc9bmw1.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_14yylm10tjkc9bmwj.resolve('slider-' + spec$$1.category + '-size-container'),
          $_14yylm10tjkc9bmwj.resolve('slider'),
          $_14yylm10tjkc9bmwj.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_55se80133jkc9box9 = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_4y8xd4ykjkc9bljy.isElement(rawStart) ? Option.some(rawStart) : $_1vcnl1ynjkc9blk6.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_bqywzp103jkc9bmfd.closest(start, function (elem) {
        return $_8kzuni116jkc9bn4w.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_8kzuni116jkc9bn4w.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_8kzuni116jkc9bn4w.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_7fg9auytjkc9blm0.eq(root, e);
    };
  ...
  var $_3u90eo134jkc9boyj = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_3u90eo134jkc9boyj.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_55se80133jkc9box9.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_3u90eo134jkc9boyj.apply(editor, value);
      },
      getInitialValue: function () {
        return $_3u90eo134jkc9boyj.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_1i9uocyvjkc9bln6.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_1i9uocyvjkc9bln6.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_1i9uocyvjkc9bln6.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_1i9uocyvjkc9bln6.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_1i9uocyvjkc9bln6.getOrDie('atob');
    return f(base64);
  };
  var $_1ldzb513fjkc9bp70 = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_1ldzb513fjkc9bp70.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_befv9l139jkc9bp6n.create($_57q9qt13ajkc9bp6p.getWidth(image), $_57q9qt13ajkc9bp6p.getHeight(image));
      context = $_befv9l139jkc9bp6n.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_3e7f3o138jkc9bp4z.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_3e7f3o138jkc9bp4z.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_3e7f3o138jkc9bp4z.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_3e7f3o138jkc9bp4z.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_3e7f3o138jkc9bp4z.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_3e7f3o138jkc9bp4z.uriToBlob(uri));
  };
  var $_ed9uov137jkc9bp4l = {
  ...
  var addImage = function (editor, blob) {
    $_ed9uov137jkc9bp4l.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_3ut9ae13ijkc9bp98.get(link);
    var url = $_anmvmyzwjkc9bmcn.get(link, 'href');
    var title = $_anmvmyzwjkc9bmcn.get(link, 'title');
    var target = $_anmvmyzwjkc9bmcn.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_anmvmyzwjkc9bmcn.get(link, 'href');
    var prevText = $_3ut9ae13ijkc9bp98.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_anmvmyzwjkc9bmcn.setAll(link, attrs);
        text.each(function (newText) {
          $_3ut9ae13ijkc9bp98.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_3hoto211bjkc9bn7j.closest(start, 'a');
  };
  var $_408s9f13hjkc9bp7w = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_1m701ry3jkc9bldm.detect();
  ...
  var $_cfz3iw13jjkc9bp9a = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_d22m6913tjkc9bpjb.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_d22m6913tjkc9bpjb.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_d22m6913tjkc9bpjb.get(input.element());
            if (current !== data) {
              $_d22m6913tjkc9bpjb.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_14yylm10tjkc9bmwj.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_4y8xd4ykjkc9bljy.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_anmvmyzwjkc9bmcn.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_anmvmyzwjkc9bmcn.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_anmvmyzwjkc9bmcn.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_anmvmyzwjkc9bmcn.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_1xtwqszujkc9bmcj.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_1xtwqszujkc9bmcj.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_14yylm10tjkc9bmwj.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_3hoto211bjkc9bn7j.descendant(dialog.element(), '.' + $_14yylm10tjkc9bmwj.resolve('serialised-dialog-chain')).each(function (parent) {
        $_8kzuni116jkc9bn4w.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_fztxq8119jkc9bn73.descendants(dialog.element(), '.' + $_14yylm10tjkc9bmwj.resolve('serialised-dialog-screen'));
      $_3hoto211bjkc9bn7j.descendant(dialog.element(), '.' + $_14yylm10tjkc9bmwj.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_8kzuni116jkc9bn4w.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_47dobq130jkc9box3.get(screens[0]);
            $_8kzuni116jkc9bn4w.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_fztxq8119jkc9bn73.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_7mimq810sjkc9bmw1.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_14yylm10tjkc9bmwj.resolve('dot-active'),
          itemClass: $_14yylm10tjkc9bmwj.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_6pvzad144jkc9bptf.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_6pvzad144jkc9bptf.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_6pvzad144jkc9bptf.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_408s9f13hjkc9bp7w.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_408s9f13hjkc9bp7w.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_5wxb4r10ujkc9bmwt.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_cfz3iw13jjkc9bp9a.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_408s9f13hjkc9bp7w.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_7fg9auytjkc9blm0.eq(originator, component.element()) && !$_7fg9auytjkc9blm0.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_2n9fk1zhjkc9bm0u.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_2n9fk1zhjkc9bm0u.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_2n9fk1zhjkc9bm0u.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_2n9fk1zhjkc9bm0u.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_2n9fk1zhjkc9bm0u.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_1xtwqszujkc9bmcj.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_1xtwqszujkc9bmcj.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_1xtwqszujkc9bmcj.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_1xtwqszujkc9bmcj.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_55ltavzxjkc9bmdm.supports(element) ? getNative(element) : $_55ltavzxjkc9bmdm.get(element);
  };
  var $_9mepy414mjkc9bqn6 = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_anmvmyzwjkc9bmcn.setAll(subject, definition.attributes().getOr({}));
    $_9mepy414mjkc9bqn6.add(subject, definition.classes().getOr([]));
    $_8kzuni116jkc9bn4w.setAll(subject, definition.styles().getOr({}));
    $_eustcq10fjkc9bml9.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_5f8gkiz0jkc9blop.append(subject, children);
    definition.value().each(function (value) {
      $_d22m6913tjkc9bpjb.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_1vcnl1ynjkc9blk6.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_2n9fk1zhjkc9bm0u.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_1139q4101jkc9bmep.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_1vcnl1ynjkc9blk6.owner(container);
    var refocus = $_1139q4101jkc9bmep.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_7fg9auytjkc9blm0.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_bqywzp103jkc9bmfd.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_1139q4101jkc9bmep.active(ownerDoc).filter(function (newFocus) {
        return $_7fg9auytjkc9blm0.eq(newFocus, oldFocus);
      }).fold(function () {
        $_1139q4101jkc9bmep.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_cy8p4lymjkc9blk3.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_cy8p4lymjkc9blk3.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_7fg9auytjkc9blm0.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_1xtwqszujkc9bmcj.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_at2lo4yhjkc9blij.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_9mepy414mjkc9bqn6.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_9mepy414mjkc9bqn6.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_3hoto211bjkc9bn7j.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_1xtwqszujkc9bmcj.remove(comp.element(), t.transitionClass());
      $_anmvmyzwjkc9bmcn.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_anmvmyzwjkc9bmcn.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_anmvmyzwjkc9bmcn.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_anmvmyzwjkc9bmcn.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_anmvmyzwjkc9bmcn.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_anmvmyzwjkc9bmcn.has(comp.element(), transConfig.stateAttr()) && $_anmvmyzwjkc9bmcn.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_anmvmyzwjkc9bmcn.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_anmvmyzwjkc9bmcn.has(comp.element(), transConfig.destinationAttr())) {
      $_anmvmyzwjkc9bmcn.set(comp.element(), transConfig.stateAttr(), $_anmvmyzwjkc9bmcn.get(comp.element(), transConfig.destinationAttr()));
      $_anmvmyzwjkc9bmcn.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_1xtwqszujkc9bmcj.add(comp.element(), t.transitionClass());
      $_anmvmyzwjkc9bmcn.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_anmvmyzwjkc9bmcn.has(e, transConfig.stateAttr()) ? Option.some($_anmvmyzwjkc9bmcn.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_14yylm10tjkc9bmwj.resolve('scrollable');
  var register = function (element) {
    $_1xtwqszujkc9bmcj.add(element, scrollable);
  };
  var deregister = function (element) {
    $_1xtwqszujkc9bmcj.remove(element, scrollable);
  };
  var $_38mm1f159jkc9brgg = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_14yylm10tjkc9bmwj.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_14yylm10tjkc9bmwj.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_7mimq810sjkc9bmw1.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_14yylm10tjkc9bmwj.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_14yylm10tjkc9bmwj.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_14yylm10tjkc9bmwj.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_8kzuni116jkc9bn4w.set(component.element(), 'overflow-y', 'auto');
                $_8kzuni116jkc9bn4w.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_38mm1f159jkc9brgg.register(component.element());
              }),
              runOnDetached(function (component) {
                $_8kzuni116jkc9bn4w.remove(component.element(), 'overflow-y');
                $_8kzuni116jkc9bn4w.remove(component.element(), '-webkit-overflow-scrolling');
                $_38mm1f159jkc9brgg.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_14yylm10tjkc9bmwj.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_47dobq130jkc9box3.get(container.element());
        $_47dobq130jkc9box3.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_47dobq130jkc9box3.get(container.element());
        var menu = $_3hoto211bjkc9bn7j.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_47dobq130jkc9box3.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_3hoto211bjkc9bn7j.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_14yylm10tjkc9bmwj.resolve('styles-background-menu'),
        menu: $_14yylm10tjkc9bmwj.resolve('styles-menu'),
        selectedMenu: $_14yylm10tjkc9bmwj.resolve('styles-selected-menu'),
        item: $_14yylm10tjkc9bmwj.resolve('styles-item'),
        selectedItem: $_14yylm10tjkc9bmwj.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_2l1r3z147jkc9bpux = { sketch: sketch$9 };
  ...
  var $_8so65u15ajkc9brhi = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_8so65u15ajkc9brhi.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_2l1r3z147jkc9bpux.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_5wxb4r10ujkc9bmwt.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_5wxb4r10ujkc9bmwt.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_5wxb4r10ujkc9bmwt.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_6scvhf12kjkc9boiv.sketch(realm, editor);
    };
    var styleFormats = $_2tgywa145jkc9bpth.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_2tgywa145jkc9bpth.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_5wxb4r10ujkc9bmwt.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_7mimq810sjkc9bmw1.receive($_6ddt7d109jkc9bmhd.orientationChanged(), Toggling.off),
            $_7mimq810sjkc9bmw1.receive($_6ddt7d109jkc9bmhd.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_e5sjg715djkc9brlc.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_e5sjg715djkc9brlc.capture(element, event, filter$1, handler);
  };
  var $_8arlv215cjkc9brkq = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_1m701ry3jkc9bldm.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_8arlv215cjkc9brkq.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_7fg9auytjkc9blm0.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_8arlv215cjkc9brkq.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_8arlv215cjkc9brkq.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_6nzdek15ijkc9brs0 = { monitor: monitor$1 };

  var isAndroid6 = $_1m701ry3jkc9bldm.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_6nzdek15ijkc9brs0.monitor(editorApi);
    var outerDoc = $_1vcnl1ynjkc9blk6.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_7fg9auytjkc9blm0.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_1139q4101jkc9bmep.active(outerDoc).filter(function (input) {
        return $_4y8xd4ykjkc9bljy.name(input) === 'input';
    ...
    var listeners = [
      $_8arlv215cjkc9brkq.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_8arlv215cjkc9brkq.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_1139q4101jkc9bmep.blur(editorApi.body());
      }),
      ...
      $_8arlv215cjkc9brkq.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_8arlv215cjkc9brkq.bind(outerDoc, 'select', updateMargin),
      $_8arlv215cjkc9brkq.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_a8xb8p15hjkc9brpa = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_anmvmyzwjkc9bmcn.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_4wxut815mjkc9brvp = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_4y8xd4ykjkc9bljy.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_4y8xd4ykjkc9bljy.name(element) === 'img' ? 1 : $_5bmmzj15pjkc9bry7.getOption(element).fold(function () {
      return $_1vcnl1ynjkc9blk6.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_5bmmzj15pjkc9bry7.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_4y8xd4ykjkc9bljy.name(elem));
  };
  var $_cdc75d15ojkc9brxp = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_3j31gf15sjkc9brzs.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_1vcnl1ynjkc9blk6.defaultView(start);
  };
  var $_4104f15rjkc9bryw = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_1vcnl1ynjkc9blk6.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_7fg9auytjkc9blm0.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_azkvap15ujkc9bs13 = {
    after: after$2,
  ...
  var $_9i926615vjkc9bs16 = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_7u9g0m15wjkc9bs1k.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_7u9g0m15wjkc9bs1k.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_7u9g0m15wjkc9bs1k.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_7u9g0m15wjkc9bs1k.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_5bmmzj15pjkc9bry7.get(textnode).length;
    var offset = $_5tjvqt160jkc9bs58.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_5tjvqt160jkc9bs58.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_bcviaz161jkc9bs5a = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_1vcnl1ynjkc9blk6.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_5tjvqt160jkc9bs58.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_4y8xd4ykjkc9bljy.isText(node) ? $_bcviaz161jkc9bs5a.locate : searchInChildren;
  ...
  var $_ae8ooe15zjkc9bs4d = { locate: locate$2 };

  var first$3 = function (element) {
    return $_bqywzp103jkc9bmfd.descendant(element, $_cdc75d15ojkc9brxp.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_cdc75d15ojkc9brxp.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_1vcnl1ynjkc9blk6.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_4rjfgu163jkc9bs6e.first : $_4rjfgu163jkc9bs6e.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_1vcnl1ynjkc9blk6.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_f7l7qm162jkc9bs62 = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_ae8ooe15zjkc9bs4d.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_f7l7qm162jkc9bs62.search(doc, elem, x);
      };
      return $_1vcnl1ynjkc9blk6.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_4104f15rjkc9bryw.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_6jhusf15yjkc9bs3z = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_7u9g0m15wjkc9bs1k.create(win);
    var self = $_eeeom6yyjkc9blnm.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_fztxq8119jkc9bn73.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_7u9g0m15wjkc9bs1k.selectNodeContentsUsing(innerRange, elem);
      return $_7u9g0m15wjkc9bs1k.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_4y8xd4ykjkc9bljy.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_2c5ux7164jkc9bs6t = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_4y8xd4ykjkc9bljy.name(element);
    if ('input' === name)
      return $_3j31gf15sjkc9brzs.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_3j31gf15sjkc9brzs.on(element, offset);
    else
      return offset === 0 ? $_3j31gf15sjkc9brzs.before(element) : $_3j31gf15sjkc9brzs.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_3j31gf15sjkc9brzs.before, beforeSpecial, $_3j31gf15sjkc9brzs.after);
    var finish = finishSitu.fold($_3j31gf15sjkc9brzs.before, beforeSpecial, $_3j31gf15sjkc9brzs.after);
    return $_4104f15rjkc9bryw.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_4104f15rjkc9bryw.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_7u9g0m15wjkc9bs1k.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_2c5ux7164jkc9bs6t.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_8azfra15xjkc9bs2c.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_csd77y165jkc9bs7c.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_csd77y165jkc9bs7c.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_4104f15rjkc9bryw.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_7u9g0m15wjkc9bs1k.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_csd77y165jkc9bs7c.preprocess(selection);
    return $_8azfra15xjkc9bs2c.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_4104f15rjkc9bryw.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_azkvap15ujkc9bs13.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_4104f15rjkc9bryw.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_7u9g0m15wjkc9bs1k.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_4104f15rjkc9bryw.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    return $_7u9g0m15wjkc9bs1k.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    return $_7u9g0m15wjkc9bs1k.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_6jhusf15yjkc9bs3z.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    return $_7u9g0m15wjkc9bs1k.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    return $_7u9g0m15wjkc9bs1k.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    var fragment = $_9i926615vjkc9bs16.fromElements(elements, win.document);
    $_7u9g0m15wjkc9bs1k.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_8azfra15xjkc9bs2c.asLtrRange(win, selection);
    $_7u9g0m15wjkc9bs1k.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_7fg9auytjkc9blm0.eq(start, finish) && soffset === foffset;
  };
  var $_1v031c15tjkc9bs0i = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_1vcnl1ynjkc9blk6.parent(start_1).bind(function (parent) {
        var selection = $_4104f15rjkc9bryw.exact(start_1, range$$1.startOffset, parent, $_cdc75d15ojkc9brxp.getEnd(parent));
        var optRect = $_1v031c15tjkc9bs0i.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_f0cxv715njkc9brvz = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_1139q4101jkc9bmep.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_4y8xd4ykjkc9bljy.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_1139q4101jkc9bmep.active().each($_1139q4101jkc9bmep.blur);
      $_1139q4101jkc9bmep.focus(iBody);
    });
  };
  var $_20saxd166jkc9bs7s = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_14yylm10tjkc9bmwj.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_anmvmyzwjkc9bmcn.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_4wxut815mjkc9brvp.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_f0cxv715njkc9brvz.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_20saxd166jkc9bs7s.resume(cWin);
    };
    var onResize = $_8arlv215cjkc9brkq.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_9ifn4115ljkc9bruc = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_1v031c15tjkc9bs0i.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_8arlv215cjkc9brkq.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_1v031c15tjkc9bs0i.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_1v031c15tjkc9bs0i.get(win).bind(function (sel) {
                return $_1v031c15tjkc9bs0i.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_1v031c15tjkc9bs0i.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_1v031c15tjkc9bs0i.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_1m701ry3jkc9bldm.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_8kzuni116jkc9bn4w.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_fztxq8119jkc9bn73.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_anmvmyzwjkc9bmcn.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_anmvmyzwjkc9bmcn.set(element, attr, backup);
          $_anmvmyzwjkc9bmcn.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_fztxq8119jkc9bn73.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_fztxq8119jkc9bn73.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_anmvmyzwjkc9bmcn.get(element, attr);
      if (restore !== 'no-styles') {
        $_anmvmyzwjkc9bmcn.set(element, 'style', restore);
      } else {
        $_anmvmyzwjkc9bmcn.remove(element, 'style');
      }
      $_anmvmyzwjkc9bmcn.remove(element, attr);
  ...
  var $_g51yqy168jkc9bsaq = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_3hoto211bjkc9bn7j.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_anmvmyzwjkc9bmcn.set(meta, 'name', 'viewport');
      $_cy8p4lymjkc9blk3.append(head, meta);
      return meta;
    };
    var element = $_3hoto211bjkc9bn7j.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_anmvmyzwjkc9bmcn.get(element, 'content');
    var maximize = function () {
      $_anmvmyzwjkc9bmcn.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_anmvmyzwjkc9bmcn.set(element, 'content', backup);
      } else {
        $_anmvmyzwjkc9bmcn.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_k0j46169jkc9bsbx = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_k0j46169jkc9bsbx.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_1xtwqszujkc9bmcj.add(platform.container, $_14yylm10tjkc9bmwj.resolve('fullscreen-maximized'));
      $_1xtwqszujkc9bmcj.add(platform.container, $_14yylm10tjkc9bmwj.resolve('android-maximized'));
      meta.maximize();
      $_1xtwqszujkc9bmcj.add(platform.body, $_14yylm10tjkc9bmwj.resolve('android-scroll-reload'));
      androidApi.set($_9ifn4115ljkc9bruc.setup(platform.win, $_56r968167jkc9bs95.getWin(platform.editor).getOrDie('no')));
      $_56r968167jkc9bs95.getActiveApi(platform.editor).each(function (editorApi) {
        $_g51yqy168jkc9bsaq.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_a8xb8p15hjkc9brpa.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_1xtwqszujkc9bmcj.remove(platform.container, $_14yylm10tjkc9bmwj.resolve('fullscreen-maximized'));
      $_1xtwqszujkc9bmcj.remove(platform.container, $_14yylm10tjkc9bmwj.resolve('android-maximized'));
      $_g51yqy168jkc9bsaq.restoreStyles();
      $_1xtwqszujkc9bmcj.remove(platform.body, $_14yylm10tjkc9bmwj.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_3j2ff715gjkc9bror = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_14yylm10tjkc9bmwj.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_14yylm10tjkc9bmwj.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_2dc7jy16ajkc9bsd1 = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_1vcnl1ynjkc9blk6.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_8kzuni116jkc9bn4w.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_2dc7jy16ajkc9bsd1.sketch(onTap, mobile.translate));
    ...
    $_cy8p4lymjkc9blk3.append(mobile.container, mask.element());
    var mode = $_3j2ff715gjkc9bror.create(mobile, maskApi);
    return {
  ...
  var $_cs0eu515fjkc9brn5 = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_14yylm10tjkc9bmwj.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_anmvmyzwjkc9bmcn.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_anmvmyzwjkc9bmcn.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_8arlv215cjkc9brkq.bind(scope, 'touchmove', function (event) {
      $_3hoto211bjkc9bn7j.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_1vadm816ijkc9bsoj = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_8kzuni116jkc9bn4w.set(component.element(), 'overflow-x', 'auto');
              $_1vadm816ijkc9bsoj.markAsHorizontal(component.element());
              $_38mm1f159jkc9brgg.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_14yylm10tjkc9bmwj.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_14yylm10tjkc9bmwj.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_14yylm10tjkc9bmwj.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_14yylm10tjkc9bmwj.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_9mepy414mjkc9bqn6.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_1xtwqszujkc9bmcj.remove(component.element(), slideConfig.openClass());
    $_1xtwqszujkc9bmcj.add(component.element(), slideConfig.closedClass());
    $_8kzuni116jkc9bn4w.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_8kzuni116jkc9bn4w.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_1xtwqszujkc9bmcj.remove(component.element(), slideConfig.closedClass());
    $_1xtwqszujkc9bmcj.add(component.element(), slideConfig.openClass());
    $_8kzuni116jkc9bn4w.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_8kzuni116jkc9bn4w.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_8kzuni116jkc9bn4w.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_8kzuni116jkc9bn4w.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_1xtwqszujkc9bmcj.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_1xtwqszujkc9bmcj.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_8kzuni116jkc9bn4w.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_1xtwqszujkc9bmcj.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_1xtwqszujkc9bmcj.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_8kzuni116jkc9bn4w.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_47dobq130jkc9box3.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_2feuiu115jkc9bn4u.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_14yylm10tjkc9bmwj.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_14yylm10tjkc9bmwj.resolve('dropup-closed'),
          openClass: $_14yylm10tjkc9bmwj.resolve('dropup-open'),
          shrinkingClass: $_14yylm10tjkc9bmwj.resolve('dropup-shrinking'),
          growingClass: $_14yylm10tjkc9bmwj.resolve('dropup-growing'),
        ...
        $_7mimq810sjkc9bmw1.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_4y8xd4ykjkc9bljy.name(event$$1.target()));
  };
  var isFirefox = $_1m701ry3jkc9bldm.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_8arlv215cjkc9brkq.capture(container, 'focus', handler);
    } else {
      return $_8arlv215cjkc9brkq.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_8arlv215cjkc9brkq.capture(container, 'blur', handler);
    } else {
      return $_8arlv215cjkc9brkq.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_1m701ry3jkc9bldm.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_8arlv215cjkc9brkq.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_8arlv215cjkc9brkq.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_1vcnl1ynjkc9blk6.defaultView(container);
    var onWindowScroll = $_8arlv215cjkc9brkq.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_1vcnl1ynjkc9blk6.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_bqywzp103jkc9bmfd.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_at2lo4yhjkc9blij.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_1vcnl1ynjkc9blk6.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_7fg9auytjkc9blm0.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_1139q4101jkc9bmep.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_4y8xd4ykjkc9bljy.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_33qnptyzjkc9blod.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_14yylm10tjkc9bmwj.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_14yylm10tjkc9bmwj.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_14yylm10tjkc9bmwj.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_14yylm10tjkc9bmwj.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_23qfq016jjkc9bspo.makeEditSwitch(webapp);
    var socket = $_23qfq016jjkc9bspo.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_cs0eu515fjkc9brn5.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_23qfq016jjkc9bspo.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_8kzuni116jkc9bn4w.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_cy8p4lymjkc9blk3.append(parent, input);
    $_1139q4101jkc9bmep.focus(input);
    operation(input);
    $_33qnptyzjkc9blod.remove(input);
  };
  var $_5iez9a173jkc9btgp = { input: input$1 };
  ...
  var $_7pkke9175jkc9btk2 = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_1139q4101jkc9bmep.active().each(function (active) {
      if (!$_7fg9auytjkc9blm0.eq(active, frame)) {
        $_1139q4101jkc9bmep.blur(active);
      }
    });
    cWin.focus();
    $_1139q4101jkc9bmep.focus(Element$$1.fromDom(cWin.document.body));
    $_7pkke9175jkc9btk2.refresh(cWin);
  };
  var $_2pwk0z174jkc9btis = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_2pwk0z174jkc9btis.resume(cWin, frame);
    };
    var toReading = function () {
      $_5iez9a173jkc9btgp.input(outerBody, $_1139q4101jkc9bmep.blur);
    };
    var captureInput = $_8arlv215cjkc9brkq.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_4y8xd4ykjkc9bljy.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_2feuiu115jkc9bn4u.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_8arlv215cjkc9brkq.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_7fg9auytjkc9blm0.eq(editorApi.html(), touchEvent.target()) || $_7fg9auytjkc9blm0.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_8arlv215cjkc9brkq.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_8arlv215cjkc9brkq.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_8arlv215cjkc9brkq.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_8arlv215cjkc9brkq.bind(toolstrip, 'touchmove', function () {
  ...
  var $_3y08df176jkc9btkh = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_1xtwqszujkc9bmcj.add(container, $_14yylm10tjkc9bmwj.resolve('unfocused-selections'));
    $_cy8p4lymjkc9blk3.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_8arlv215cjkc9brkq.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_2pwk0z174jkc9btis.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_9mepy414mjkc9bqn6.add(span, [
        $_14yylm10tjkc9bmwj.resolve('layer-editor'),
        $_14yylm10tjkc9bmwj.resolve('unfocused-selection')
      ]);
      $_8kzuni116jkc9bn4w.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_f0cxv715njkc9brvz.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_5f8gkiz0jkc9blop.append(container, spans);
    };
    var clear = function () {
      $_33qnptyzjkc9blod.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_33qnptyzjkc9blod.remove(container);
    };
    var isActive = function () {
      return $_1vcnl1ynjkc9blk6.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_927xry17gjkc9btwj = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_927xry17gjkc9btwj.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_bmixdw15bjkc9brio.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_1vcnl1ynjkc9blk6.owner(socket).dom().defaultView;
    var viewportHeight = $_2feuiu115jkc9bn4u.get(socket) + $_2feuiu115jkc9bn4u.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_2feuiu115jkc9bn4u.get(socket) + $_2feuiu115jkc9bn4u.get(dropup) - greenzoneHeight;
    $_8kzuni116jkc9bn4w.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_cioqu617fjkc9btvr = {
  ...
  var yFixedData = 'data-' + $_14yylm10tjkc9bmwj.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_14yylm10tjkc9bmwj.resolve('y-property');
  var yScrollingData = 'data-' + $_14yylm10tjkc9bmwj.resolve('scrolling');
  var windowSizeData = 'data-' + $_14yylm10tjkc9bmwj.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_4wxut815mjkc9brvp.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_anmvmyzwjkc9bmcn.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_4wxut815mjkc9brvp.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_anmvmyzwjkc9bmcn.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_fztxq8119jkc9bn73.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_anmvmyzwjkc9bmcn.get(toolbar, 'style');
    $_8kzuni116jkc9bn4w.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_anmvmyzwjkc9bmcn.set(toolbar, yFixedData, '0px');
    $_anmvmyzwjkc9bmcn.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_anmvmyzwjkc9bmcn.set(toolbar, 'style', oldToolbarStyle || '');
      $_anmvmyzwjkc9bmcn.remove(toolbar, yFixedData);
      $_anmvmyzwjkc9bmcn.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_anmvmyzwjkc9bmcn.get(viewport, 'style');
    $_38mm1f159jkc9brgg.register(viewport);
    $_8kzuni116jkc9bn4w.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_anmvmyzwjkc9bmcn.set(viewport, yFixedData, toolbarHeight + 'px');
    $_anmvmyzwjkc9bmcn.set(viewport, yScrollingData, 'true');
    $_anmvmyzwjkc9bmcn.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_38mm1f159jkc9brgg.deregister(viewport);
      $_anmvmyzwjkc9bmcn.set(viewport, 'style', oldViewportStyle || '');
      $_anmvmyzwjkc9bmcn.remove(viewport, yFixedData);
      $_anmvmyzwjkc9bmcn.remove(viewport, yScrollingData);
      $_anmvmyzwjkc9bmcn.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_anmvmyzwjkc9bmcn.get(dropup, 'style');
    $_8kzuni116jkc9bn4w.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_anmvmyzwjkc9bmcn.set(dropup, yFixedData, '0px');
    $_anmvmyzwjkc9bmcn.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_anmvmyzwjkc9bmcn.set(dropup, 'style', oldDropupStyle || '');
      $_anmvmyzwjkc9bmcn.remove(dropup, yFixedData);
      $_anmvmyzwjkc9bmcn.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_1vcnl1ynjkc9blk6.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_anmvmyzwjkc9bmcn.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_1vcnl1ynjkc9blk6.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_2feuiu115jkc9bn4u.get(toolbar);
    var dropupHeight = $_2feuiu115jkc9bn4u.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_2feuiu115jkc9bn4u.get(toolbar);
        var dropupHeight_1 = $_2feuiu115jkc9bn4u.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_anmvmyzwjkc9bmcn.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_8kzuni116jkc9bn4w.set(viewport, 'height', newHeight + 'px');
        $_8kzuni116jkc9bn4w.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_cioqu617fjkc9btvr.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_anmvmyzwjkc9bmcn.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_cioqu617fjkc9btvr.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_adouqd17ejkc9btte = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_endr5z17djkc9btsy.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_14yylm10tjkc9bmwj.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_8kzuni116jkc9bn4w.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_8kzuni116jkc9bn4w.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_8kzuni116jkc9bn4w.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_anmvmyzwjkc9bmcn.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_4wxut815mjkc9brvp.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_anmvmyzwjkc9bmcn.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_anmvmyzwjkc9bmcn.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_8kzuni116jkc9bn4w.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_adouqd17ejkc9btte.getYFixedData(element) + 'px';
    $_8kzuni116jkc9bn4w.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_1vcnl1ynjkc9blk6.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_cioqu617fjkc9btvr.getGreenzone(socket, dropup);
    var refreshCursor = curry($_7pkke9175jkc9btk2.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_b9itq179jkc9btra.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_b9itq179jkc9btra.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_a3loob17ijkc9btxs = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_8kzuni116jkc9bn4w.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_8kzuni116jkc9bn4w.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_b9itq179jkc9btra.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_i6fef17jjkc9bty4.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_8arlv215cjkc9brkq.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_i6fef17jjkc9bty4.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_adouqd17ejkc9btte.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_at2lo4yhjkc9blij.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_bmixdw15bjkc9brio.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_a3loob17ijkc9btxs.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_8kzuni116jkc9bn4w.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_b9itq179jkc9btra.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_5iez9a173jkc9btgp.input($_at2lo4yhjkc9blij.body(), $_1139q4101jkc9bmep.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_67ymp5177jkc9btm0 = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_56r968167jkc9bs95.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_8kzuni116jkc9bn4w.getRaw(platform.socket, 'height'),
          iframeHeight: $_8kzuni116jkc9bn4w.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_1vadm816ijkc9bsoj.exclusive(doc, '.' + $_38mm1f159jkc9brgg.scrollable()) });
        $_1xtwqszujkc9bmcj.add(platform.container, $_14yylm10tjkc9bmwj.resolve('fullscreen-maximized'));
        $_g51yqy168jkc9bsaq.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_8kzuni116jkc9bn4w.set(platform.socket, 'overflow', 'scroll');
        $_8kzuni116jkc9bn4w.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_1139q4101jkc9bmep.focus(editorApi.body());
        ...
        iosApi.set($_67ymp5177jkc9btm0.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_1r51jn172jkc9bteg.stubborn,
        ...
        iosEvents.set($_3y08df176jkc9btkh.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_8kzuni116jkc9bn4w.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_8kzuni116jkc9bn4w.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_1xtwqszujkc9bmcj.remove(platform.container, $_14yylm10tjkc9bmwj.resolve('fullscreen-maximized'));
      $_g51yqy168jkc9bsaq.restoreStyles();
      $_38mm1f159jkc9brgg.deregister(platform.toolbar);
      $_8kzuni116jkc9bn4w.remove(platform.socket, 'overflow');
      $_8kzuni116jkc9bn4w.remove(platform.socket, '-webkit-overflow-scrolling');
      $_1139q4101jkc9bmep.blur(platform.editor.getFrame());
      $_56r968167jkc9bs95.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_au50ot171jkc9btc3 = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_8kzuni116jkc9bn4w.set(mobile.toolstrip, 'width', '100%');
    $_8kzuni116jkc9bn4w.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_2dc7jy16ajkc9bsd1.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_au50ot171jkc9btc3.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_9x8ruh170jkc9btas = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_14yylm10tjkc9bmwj.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_23qfq016jjkc9bspo.makeEditSwitch(webapp);
    var socket = $_23qfq016jjkc9bspo.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_9x8ruh170jkc9btas.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_3nwbx17mjkc9btzg = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_6ddt7d109jkc9bmhd.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_6h4j1517pjkc9bu0l = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_3nwbx17mjkc9btzg.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_6h4j1517pjkc9bu0l.fireSkinLoaded(editor));
      } else {
        $_6h4j1517pjkc9bu0l.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_1m701ry3jkc9bldm.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_cy8p4lymjkc9blk3.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_1139q4101jkc9bmep.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_bmixdw15bjkc9brio.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_6ddt7d109jkc9bmhd.orientationChanged()], { width: $_bmixdw15bjkc9brio.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_14yylm10tjkc9bmwj.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_4y8xd4ykjkc9bljy.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_4y8xd4ykjkc9bljy.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_ylhrr107jkc9bmh3.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_14yylm10tjkc9bmwj.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_14yylm10tjkc9bmwj.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_6ddt7d109jkc9bmhd.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_5wxb4r10ujkc9bmwt.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_5wxb4r10ujkc9bmwt.forToolbar('readonly-back', function () {
        ...
        var features = $_da2yn510ajkc9bmhm.setup(realm, editor);
        var items = $_da2yn510ajkc9bmhm.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_1n1ntr17ojkc9btzs.init(realm, editor);
      });
      return {
