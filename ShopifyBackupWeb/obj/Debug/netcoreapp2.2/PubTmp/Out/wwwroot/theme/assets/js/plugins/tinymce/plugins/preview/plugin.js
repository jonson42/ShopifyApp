...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_79gnmljfjkc9beao.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_79gnmljfjkc9beao.getPreviewDialogWidth(editor);
    var dialogHeight = $_79gnmljfjkc9beao.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_4mmiqejgjkc9beaq.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_tu9fkjdjkc9beal = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_tu9fkjdjkc9beal.open(editor);
    });
  };
  var $_2o969fjcjkc9beaj = { register: register };
  ...
  var $_euwivjijkc9beav = { register: register$1 };

  global.add('preview', function (editor) {
    $_2o969fjcjkc9beaj.register(editor);
    $_euwivjijkc9beav.register(editor);
  });
  function Plugin () {
  }
