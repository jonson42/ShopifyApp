...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_9g2se4agjkc9bclb.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_elbiw1abjkc9bciz.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_8cqhr1adjkc9bcj4.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_2gv483ahjkc9bcld = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_cm5brjaajkc9bciw = {
    open: function (editor) {
      var minWidth = $_elbiw1abjkc9bciz.getDialogMinWidth(editor);
      var minHeight = $_elbiw1abjkc9bciz.getDialogMinHeight(editor);
      var currentLanguage = $_2gv483ahjkc9bcld.getCurrentLanguage(editor);
      var currentLanguages = $_2gv483ahjkc9bcld.getLanguages(editor);
      var currentCode = $_8cqhr1adjkc9bcj4.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_8cqhr1adjkc9bcj4.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_9g2se4agjkc9bclb.isCodeSample(node)) {
        $_cm5brjaajkc9bciw.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_3l9uq8a9jkc9bciu = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_9g2se4agjkc9bclb.trimArg($_9g2se4agjkc9bclb.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_9g2se4agjkc9bclb.trimArg($_9g2se4agjkc9bclb.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_dwh9ctaijkc9bclg = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_elbiw1abjkc9bciz.getContentCss(editor);
  ...
  var $_aq9y60ajjkc9bclk = { loadCss: loadCss };
  ...
  var $_bdkh9jakjkc9bcln = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_dwh9ctaijkc9bclg.setup(editor);
    $_bdkh9jakjkc9bcln.register(editor);
    $_3l9uq8a9jkc9bciu.register(editor);
    editor.on('init', function () {
      $_aq9y60ajjkc9bclk.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_9g2se4agjkc9bclb.isCodeSample(ev.target)) {
        $_cm5brjaajkc9bciw.open(editor);
      }
    });
  });
