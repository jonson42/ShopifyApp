...
var wordcount = (function () {
  ...
  var $_d44ls4tjjkc9bk1i = {
    each: each,
    map: map
  };

  var SETS$1 = $_cyxnwbthjkc9bk1a.SETS;
  var OTHER = $_cyxnwbthjkc9bk1a.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_d44ls4tjjkc9bk1i.map(string.split(''), memoized);
  };
  var $_199turtijkc9bk1f = { classify: classify };

  var ci = $_cyxnwbthjkc9bk1a.characterIndices;
  ...
  var $_df0dvstkjkc9bk1l = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_cyxnwbthjkc9bk1a.EMPTY_STRING;
  var WHITESPACE$1 = $_cyxnwbthjkc9bk1a.WHITESPACE;
  var PUNCTUATION$1 = $_cyxnwbthjkc9bk1a.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_199turtijkc9bk1f.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_df0dvstkjkc9bk1l.isWordBoundary(map, i)) {
  ...
  var $_byyzt3tgjkc9bk13 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_byyzt3tgjkc9bk13.getWords(getTextContent(editor)).length;
  };
  var $_br071ttfjkc9bk11 = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_br071ttfjkc9bk11.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_7ntxlqtejkc9bk0z = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_br071ttfjkc9bk11.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_bftvidtljkc9bk1q = { setup: setup };

  global.add('wordcount', function (editor) {
    $_bftvidtljkc9bk1q.setup(editor);
    return $_7ntxlqtejkc9bk0z.get(editor);
  });
  function Plugin () {
  }
