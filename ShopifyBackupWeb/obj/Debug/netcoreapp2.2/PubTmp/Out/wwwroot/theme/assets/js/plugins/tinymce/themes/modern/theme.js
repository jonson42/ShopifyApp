...
var modern = (function () {
  ...
  var $_6locc7u0jkc9bk3b = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_77pl1qu4jkc9bk3o.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_77pl1qu4jkc9bk3o.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_3a196nu7jkc9bk49.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_77pl1qu4jkc9bk3o.setUiContainer(editor, panel);
  ...
  var $_6p4uo4u1jkc9bk3e = { addContextualToolbars: addContextualToolbars };
  ...
  var $_6d2re6u8jkc9bk4f = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_c7bidjtzjkc9bk39.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_cm2kdaubjkc9bk55 = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_c7bidjtzjkc9bk39.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_45xdmluejkc9bk5b = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_8upkwgucjkc9bk58.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_45xdmluejkc9bk5b.fireSkinLoaded(editor));
    } else {
      $_45xdmluejkc9bk5b.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_6d2re6u8jkc9bk4f.createMenuButtons(editor)
            },
            $_3a196nu7jkc9bk49.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_8upkwgucjkc9bk58.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_77pl1qu4jkc9bk3o.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_cm2kdaubjkc9bk55.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_cm2kdaubjkc9bk55.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_c7bidjtzjkc9bk39.fireBeforeRenderUI(editor);
    ...
    $_6locc7u0jkc9bk3b.addKeys(editor, panel);
    $_6p4uo4u1jkc9bk3e.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_2dficatvjkc9bk2y = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_77pl1qu4jkc9bk3o.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_77pl1qu4jkc9bk3o.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_abhepgukjkc9bk6e = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_77pl1qu4jkc9bk3o.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_aha916uqjkc9bk7n.parseBox(settings.border);
      self$$1.paddingBox = $_aha916uqjkc9bk7n.parseBox(settings.padding);
      self$$1.marginBox = $_aha916uqjkc9bk7n.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_77pl1qu4jkc9bk3o.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_aha916uqjkc9bk7n.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_aha916uqjkc9bk7n.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_aha916uqjkc9bk7n.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_45xdmluejkc9bk5b.fireSkinLoaded(editor));
    } else {
      $_45xdmluejkc9bk5b.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_6ax7whufjkc9bk5f = { render: render$1 };
  ...
  var $_8wco33v2jkc9bk8z = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_8wco33v2jkc9bk8z.setup(editor, theme);
    return isInline(editor) ? $_6ax7whufjkc9bk5f.render(editor, theme, args) : $_2dficatvjkc9bk2y.render(editor, theme, args);
  };
  var $_9wyaa4trjkc9bk2p = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_abhepgukjkc9bk6e],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_77pl1qu4jkc9bk3o.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_aha916uqjkc9bk7n.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_aha916uqjkc9bk7n.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_9wyaa4trjkc9bk2p.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_cm2kdaubjkc9bk55.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_cm2kdaubjkc9bk55.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_3d2oy9w5jkc9bkfs.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_3d2oy9w5jkc9bkfs.ELEMENT);
  var isText = isType$1($_3d2oy9w5jkc9bkfs.TEXT);
  var isDocument = isType$1($_3d2oy9w5jkc9bkfs.DOCUMENT);
  var $_5yw06aw4jkc9bkfp = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_5yw06aw4jkc9bkfp.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_6uvhd9wcjkc9bki9 = { toArray: toArray };
  ...
  var $_s36awwfjkc9bkjn = { getOrDie: getOrDie };

  var node = function () {
    var f = $_s36awwfjkc9bkjn.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_dv7qn9wljkc9bkko.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_dv7qn9wljkc9bkko.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_dv7qn9wljkc9bkko.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_81udfwpjkc9bklr = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_81udfwpjkc9bklr.browsers();
    var oses = $_81udfwpjkc9bklr.oses();
    var browser = $_4epv25wojkc9bklg.detectBrowser(browsers, userAgent).fold($_6pvm33wkjkc9bkkc.unknown, $_6pvm33wkjkc9bkkc.nu);
    var os = $_4epv25wojkc9bklg.detectOs(oses, userAgent).fold($_5se43awmjkc9bkkq.unknown, $_5se43awmjkc9bkkq.nu);
  ...
  var $_5k8vruwjjkc9bkkb = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_5k8vruwjjkc9bkkb.detect(userAgent);
  });
  var $_54hwyawijkc9bkk1 = { detect: detect$3 };

  var ELEMENT = $_3d2oy9w5jkc9bkfs.ELEMENT;
  var DOCUMENT = $_3d2oy9w5jkc9bkfs.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_8o5ycqwejkc9bkjl.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_54hwyawijkc9bkk1.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_dkdy1swdjkc9bkic = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_g3u346wtjkc9bkml.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_dkdy1swdjkc9bkic.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_dkdy1swdjkc9bkic.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_6uvhd9wcjkc9bki9.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_6uvhd9wcjkc9bki9.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_51jbexw2jkc9bkfb.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_fdaecjw6jkc9bkfz.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_fdaecjw6jkc9bkfz.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_fdaecjw6jkc9bkfz.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_fdaecjw6jkc9bkfz.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_g3u346wtjkc9bkml.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_bz4g5iw1jkc9bkex.ancestors(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_bz4g5iw1jkc9bkex.siblings(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_bz4g5iw1jkc9bkex.children(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_g3u346wtjkc9bkml.all(selector, scope);
  };
  var $_cj4542w0jkc9bkev = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_cj4542w0jkc9bkev.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_a8n9wjvxjkc9bkcw = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_a8n9wjvxjkc9bkcw.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_51jbexw2jkc9bkfb.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_dkdy1swdjkc9bkic.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_g3u346wtjkc9bkml.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_4l7kj7wzjkc9bko2.ancestor(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_4l7kj7wzjkc9bko2.sibling(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_4l7kj7wzjkc9bko2.child(scope, function (e) {
      return $_g3u346wtjkc9bkml.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_g3u346wtjkc9bkml.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_g3u346wtjkc9bkml.is, ancestor$1, scope, selector, isRoot);
  };
  var $_6qw1v1wyjkc9bknz = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_cocrpnx1jkc9bkq0 = { register: register };
  ...
  var $_7wy7b7x3jkc9bkq6 = { register: register$1 };
  ...
  var $_87puwvx4jkc9bkqb = { register: register$2 };
  ...
  var $_hy4pix5jkc9bkqf = { register: register$3 };
  ...
  var $_644p6ex6jkc9bkqj = { register: register$4 };
  ...
  var $_38wgy6x7jkc9bkqm = { register: register$5 };
  ...
  var $_caonpvx8jkc9bkqw = { register: register$6 };
  ...
  var $_euzphax9jkc9bkqy = { register: register$7 };
  ...
  var $_g2qlk7xajkc9bkr0 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_6qw1v1wyjkc9bknz.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_644p6ex6jkc9bkqj.register(editor);
    $_cocrpnx1jkc9bkq0.register(editor);
    $_caonpvx8jkc9bkqw.register(editor);
    $_euzphax9jkc9bkqy.register(editor);
    $_87puwvx4jkc9bkqb.register(editor);
    $_7wy7b7x3jkc9bkq6.register(editor);
    $_hy4pix5jkc9bkqf.register(editor);
    $_g2qlk7xajkc9bkr0.register(editor);
    $_38wgy6x7jkc9bkqm.register(editor);
  };
  var $_95o3cjwxjkc9bkng = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_33eugxuxjkc9bk8b,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_4oi35kuzjkc9bk8p,
      Panel: Panel,
      Movable: $_abhepgukjkc9bk6e,
      Resizable: $_ch2hi8v1jkc9bk8x,
      ...
      FormatControls: $_95o3cjwxjkc9bkng,
  ...
  global.add('modern', function (editor) {
    $_95o3cjwxjkc9bkng.setup(editor);
    return $_5y5mrntqjkc9bk2n.get(editor);
  });
  function Theme () {
  }
